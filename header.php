<head>
		...
		<title>Academic Pathway Planner</title>
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a class="logo" href="main.php">NEW FORTUNE</a>
					</div>
					<!-- /Logo -->
					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								<a href="http://localhost/NEW_FORTUNE/login.php">Career Prediction</a>
                                <a href="http://localhost/NEW_FORTUNE/login.php">Courses</a>
